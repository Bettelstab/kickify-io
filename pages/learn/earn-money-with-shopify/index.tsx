...
export default function EarnMoneyWithShopify() {
  return (
    ...
    >
      ...
      <ul>
        <li>
          Selling Products: You can make money with Shopify by selling products
          directly to customers from your online store. You can create your own
          product line and list it on your store or look for dropshipping
          suppliers who will ship products to your customers.
        </li>
        <li>
        ...
        <li>
          ...
          products and services on your store. You’ll receive a commission when
          customers purchase the products or services you’re promoting.
        </li>
        <li>
        ...
        <li>
          ...
          your store to businesses that are related to your product niche. This
          is a great way to monetize your store without having to sell products.
        </li>
        <li>

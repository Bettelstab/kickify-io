  ...
  return (
    ...
    >
      ...
      <div className={styles.articles}>
        ...
        <ArticleTeaser title="Comparing hosting providers" slug="comparing-hosting-providers">
        ...
        <ArticleTeaser title="Earn money with Shopify" slug="earn-money-with-shopify">
          While Shopify itself provides a great hosting solution for stores, as
          an app developer you need to host your app yourself. Here are some
          options and considerations.
        </ArticleTeaser>

  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          Offer Services: You can offer Shopify-related services such as custom
          development, marketing, and design.
        </li>
        <li>
          Referrals & Affiliates: You can create an affiliate program that pays
          you for referrals, or join existing affiliate programs to earn
          additional revenue.
        </li>
        <li>
          Advertise: You can advertise your app on Google and other networks to
        ...
        <li>
          Subscriptions: You can offer subscription plans for access to your app
          and its features.
        </li>
        <li>
